...
while waiting_for_input:
    ...
    print('p: Output the blockchain blocks')
    print('o: Output participants')
    print('c: Check transaction validity')
    ...
    if user_choice == 'a':
        ...
        if len(blockchain) >= 1:
            blockchain[0] = {
                'previous_hash': '',
                'index': 0,
                'transactions': [{'sender': 'Chris', 'recipient': 'Fast Eddy', 'amount': 100.0}]
            }
    elif user_choice == 'q':
    ...
    if not verify_chain():
        ...
        break
    print('Balance of {}: {:6.2f}'.format('Fast Eddy', get_balance('Fast Eddy')))
else:
    print('User left!')
